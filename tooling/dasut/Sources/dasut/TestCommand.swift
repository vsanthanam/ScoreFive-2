...
struct TestCommand: ParsableCommand, DasutCommand {
    ...
    func action() throws {
        ...
        let command = "xcodebuild -workspace \(workspace)/ScoreFive.xcworkspace -sdk iphonesimulator -scheme ScoreFive -destination 'platform=iOS Simulator,name=\(device),OS=\(os)' test"
